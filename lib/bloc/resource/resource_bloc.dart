...
class ResourceBloc extends Bloc<ResourceEvent, ResourceState> {
  ...
  void _onLoadResources(LoadResourcesEvent event, Emitter<ResourceState> emit) async {
  ...
  void _onAddResource(AddResourceEvent event, Emitter<ResourceState> emit) async {
    emit(ResourceLoading());
    try {
      ...
      final internalPath = await _copyImageToInternalStorage(event.imagePath, nextId);
  ...
  void _onRemoveResource(RemoveResourceEvent event, Emitter<ResourceState> emit) async {
    emit(ResourceLoading());
    try {
  ...
  Future<String> _copyImageToInternalStorage(String sourcePath, int resourceId) async {
